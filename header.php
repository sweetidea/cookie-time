...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
  		...
  		<script type="text/javascript">
			...
			*/
		    ...
		    function drawDeliveryZones ( map ) {
    			...
    			var boston = [new google.maps.LatLng(42.353406,-71.137247),
			...
			var cambridge = [new google.maps.LatLng(42.382323,-71.130724),
							new google.maps.LatLng(42.369357,-71.122742),
							new google.maps.LatLng(42.368564,-71.116991), 
							new google.maps.LatLng(42.354992,-71.115189),
							new google.maps.LatLng(42.353153,-71.108665),
			...
			var frankenblob = [new google.maps.LatLng(42.382323,-71.130724),
				...
				var cambridgeZone = new google.maps.Polygon({
					paths: cambridge,
					strokeColor: "#569556",
					strokeOpacity: 0.8,
					strokeWeight: 2.0,
				...
				var frankenblobZone = new google.maps.Polygon({
					paths: frankenblob,
					strokeColor: "#569556",
					strokeOpacity: 0.8,
					strokeWeight: 2.0,
				...
				//cambridgeZone.setMap(map);
				frankenblobZone.setMap(map);
    		}
    ...
    <div id="sweetIdeaInfo" class="fourcol widget_header">
    ...
    <div id="cookiegram" class="fourcol widget_header">
    	<h4>SEND A COOKIEGRAM</h4>
    	Spread the love of cookies. Don't know what a Cookiegram is? <a href="http://getcooki.es/cookiegram">Learn more.</a>
    	<a href="http://gum.co/mQuGm"><input class="greenButton" type="button" value="SEND A COOKIEGRAM"></a><script type="text/javascript" src="https://gumroad.com/js/gumroad.js"></script>
    </div>
